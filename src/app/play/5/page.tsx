                ...
                <div className="px-4 py-3 border-t border-white/5">
                    ...
                    <form onSubmit={handleSubmit} className="flex gap-2">
                        <input
                            ...
                            className="flex-1 bg-black/50 border border-white/10 rounded px-3 py-2 font-mono text-sm text-orange-400 focus:border-orange-500 outline-none disabled:opacity-50"
                        />
                        <button
                            type="submit"
                            disabled={status === 'correct' || status === 'submitting'}
                            className={`px-4 py-2 rounded font-bold text-sm flex items-center gap-1.5 transition-all ${status === 'correct' ? 'bg-green-500 text-black' : 'bg-orange-500 text-white hover:bg-orange-400'
                                }`}
                        >
                            {status === 'correct' ? (
